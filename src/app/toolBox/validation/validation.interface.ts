import type { IResult } from "../result/interfaces/result.interface";
...
type BaseValidationError = {
	code:
		| ValidationErrorCode.NOT_A_STRING
		| ValidationErrorCode.NOT_AN_OBJECT
		| ValidationErrorCode.NOT_AN_ARRAY
		| ValidationErrorCode.NOT_A_NUMBER;
	path: string;
};
