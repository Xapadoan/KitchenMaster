...
import { type Ingredient, Unit } from "../../interfaces/recipe.interface";
...
export function ShpLsPrsrIngredientAdapter(
	shplsprsr: ShpLsPrsrIngredient,
): Ingredient {
...
export class ShpLsPrsrIngredientValidator
	implements IValidate<ShpLsPrsrIngredient>
{
